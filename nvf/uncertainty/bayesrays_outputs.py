...
from nvf.uncertainty.bayesrays_utils import normalize_point_coords, find_grid_indices
...
def get_output_fn(model):
    """Dynamically selects the appropriate output function based on the model type."""
